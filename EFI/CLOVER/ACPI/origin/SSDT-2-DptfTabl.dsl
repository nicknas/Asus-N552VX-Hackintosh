 ...
 *
 * Disassembly of SSDT-2-DptfTabl.aml, Sun Sep 15 23:16:16 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003D69 (15721)
 *     Revision         0x02
 *     Checksum         0x39
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (CPL1, 0, NotSerialized)
        {
            Store (0x02, Index (\_SB.PCI0.B0D4.NPCC, Zero))
            Store (Zero, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), Zero))
            Store (0x9088, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), One))
            ...
            Store (0x03E8, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x05))
            Store (One, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), Zero))
            Store (0xEA60, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), One))
